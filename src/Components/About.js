        ...
        <div className="container" style={style}>
            <div className="accordion" id="accordionExample" >
                ...
                <div className="accordion-item" >
                    ...
                    <div style={style} id="collapseTwo" className="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                ...
                <div className="accordion-item">
                    ...
                    <div style={style} id="collapseThree" className="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                        <div className="accordion-body">
            ...
            <button onClick={tooglemode} className="btn btn-dark my-3" type="button">{btntext}</button>
        </div>
    )
}
